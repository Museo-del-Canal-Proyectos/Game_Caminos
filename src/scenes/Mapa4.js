...
class Mapa4 extends BaseScene {
  ...
  create() {
    ...
    this.punto3= this.add.image(916,160,'punto').setOrigin(0);
    console.log(this.punto3);
  ...
  createBotonW1() {
    ...
    this.boton.create(695, 165, 'block_3')
      .setScale(0.1,0.3)
      .setImmovable(true)
      .setOrigin(0, 0);
  }
  ...
  createPersonaje() {
    this.personaje = this.physics.add.sprite(925, 146, sessionStorage.getItem('selectPLayer'))
      .setScale(0.5)
      .setOrigin(0);
